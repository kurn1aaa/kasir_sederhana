    ...
    <div class="col-md-8">
        ...
        <div class="card card-custom p-4 mb-5">
            <div class="border-bottom pb-3 mb-4">
                <h4 class="fw-bold mb-1 text-dark" style="letter-spacing: -0.5px;">Ubah Nama Kategori</h4>
                <p class="text-muted small mb-0">Perbarui nama stasiun barista di sistem.</p>
            </div>
            ...
            <form action="/admin/kategori/{{ $kategori->id }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama_kategori" id="nama_kategori" class="form-control rounded-3 @error('nama_kategori') is-invalid @enderror" value="{{ old('nama_kategori', $kategori->nama_kategori) }}" style="border-color: #eedfd4; height: 45px; font-size: 14px;" required>
                    @error('nama_kategori')
                ...
                <div class="d-flex justify-content-end gap-2 border-top pt-3">
                    ...
                    <button type="submit" class="btn-premium-primary px-4" style="height: 42px;"><i class="fa-solid fa-square-check me-2"></i> Perbarui Kategori</button>
                </div>
            </form>
        </div>
    </div>
